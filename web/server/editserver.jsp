...
<html>
    ...
    <link rel="stylesheet" href="./public/style/editserver.css">
...
<body>
    ...
    <div class="select d-flex justify-content-center">
        <h2 id="customer">${person.firstName} ${person.lastName}</h2>
    </div>
    <div class="container d-flex flex-column justify-content-center align-items-center">
        <div class="segment d-flex justify-content-between">
            <div class="segment-part">
                ...
                <input id="datePicker" type="date" data-started="${server.formatDate(server.getStartDate())}" value="${server.formatDate(server.getEndDate())}">
            </div>
            <div class="segment-part">
                <div class="segment-header">OS</div>
                <select class="form-select" aria-label="Default select example">
                    <option value="Ubuntu"
                            <c:if test="${fn:toLowerCase(fn:trim(server.getOs())) eq 'ubuntu'}">
                                selected
                            </c:if>>Ubuntu</option>
                    <option value="Windows"
                            <c:if test="${fn:toLowerCase(fn:trim(server.getOs())) eq 'windows'}">
                                selected
                            </c:if>>Windows</option>
                </select>
            </div>
        ...
        <div class="segment">
            ...
            <div class="d-flex justify-content-around">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioCpu" id="radio1" data-price="0.00" value="CPU 2 Cores (FREE)" 
                           <c:if test="${fn:toLowerCase(fn:trim(server.getCpu())) eq 'cpu 2 cores (free)'}">
                               checked
                           </c:if>
                           />
                    <label class="form-check-label" for="radio1">
                        <span>CPU 2 Cores</span> (FREE)
                    </label>    
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioCpu" id="radio2" data-price="8.00" value="CPU 4 Cores (€8.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getCpu())) eq 'cpu 4 cores (€8.00)'}">
                               checked
                           </c:if>
                           />
                    <label class="form-check-label" for="radio2">
                        <span>CPU 4 Cores</span> (€<span>8.00</span>)
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioCpu" id="radio3" data-price="12.00" value="CPU 8 Cores (€12.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getCpu())) eq 'cpu 8 cores (€12.00)'}">
                               checked
                           </c:if>
                           />
                    <label class="form-check-label" for="radio3">
                        <span>CPU 8 Cores</span> (€<span>12.00</span>)
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioCpu" id="radio4" data-price="18.00" value="CPU 12 Cores (€18.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getCpu())) eq 'cpu 12 cores (€18.00)'}">
                               checked
                           </c:if>
                           />
                    <label class="form-check-label" for="radio4">
                        <span>CPU 12 Cores</span> (€<span>18.00</span>)
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioCpu" id="radio5" data-price="22.00" value="CPU 16 Cores (€22.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getCpu())) eq 'cpu 16 cores (€22.00)'}">
                               checked
                           </c:if>
                           />
                    <label class="form-check-label" for="radio5">
                        <span>CPU 16 Cores</span> (€<span>22.00</span>)
                    </label>
                </div>
            </div>
        </div>
        <div class="segment">
            ...
            <div class="d-flex justify-content-around">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioRam" id="radio6" data-price="0.00" value="4 GB RAM (FREE)" 
                           <c:if test="${fn:toLowerCase(fn:trim(server.getRam())) eq '4 gb ram (free)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioRam" id="radio7" data-price="8.00" value="8 GB RAM (€8.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getRam())) eq '8 gb ram (€8.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioRam" id="radio8" data-price="12.00" value="12 GB RAM (€12.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getRam())) eq '12 gb ram (€12.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioRam" id="radio9" data-price="16.00" value="16 GB RAM (€16.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getRam())) eq '16 gb ram (€16.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioRam" id="radio10" data-price="28.00" value="32 GB RAM (€32.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getRam())) eq '32 gb ram (€32.00)'}">
                               checked
                           </c:if>
                           />
        ...
        <div class="segment">
            ...
            <div class="d-flex justify-content-around">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioDiskSpace" id="radio11" data-price="0.00" value="500 GB HDD (FREE)" 
                           <c:if test="${fn:toLowerCase(fn:trim(server.getDiskSpace())) eq '500 gb hdd (free)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioDiskSpace" id="radio12" data-price="4.00" value="1.0 TB HDD (€4.00)" 
                           <c:if test="${fn:toLowerCase(fn:trim(server.getDiskSpace())) eq '1.0 tb hdd (€4.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioDiskSpace" id="radio13" data-price="8.00" value="500 GB SSD (€8.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getDiskSpace())) eq '500 gb ssd (€8.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioDiskSpace" id="radio14" data-price="12.00" value="1.0 TB SSD (€12.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getDiskSpace())) eq '1.0 tb ssd (€12.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioDiskSpace" id="radio15" data-price="16.00" value="2.0 TB SSD (€16.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getDiskSpace())) eq '2.0 tb ssd (€16.00)'}">
                               checked
                           </c:if>
                           />
        ...
        <div class="segment">
            ...
            <div class="d-flex justify-content-around">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioBandwidth" id="radio16" data-price="0.00" value="Bandwidth 500 GB (FREE)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getBandwidth())) eq 'bandwidth 500 gb (free)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioBandwidth" id="radio17" data-price="4.00" value="Bandwidth 1.0 TB (€4.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getBandwidth())) eq 'bandwidth 1.0 tb (€4.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioBandwidth" id="radio18" data-price="8.00" value="Bandwidth 2.0 TB (€8.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getBandwidth())) eq 'bandwidth 2.0 tb (€8.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioBandwidth" id="radio19" data-price="12.00" value="Bandwidth 4.0 TB (€12.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getBandwidth())) eq 'bandwidth 4.0 tb (€12.00)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioBandwidth" id="radio20" data-price="16.00" value="Bandwidth 8.0 TB (€16.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getBandwidth())) eq 'bandwidth 8.0 tb (€16.00)'}">
                               checked
                           </c:if>
                           />
        ...
        <div class="segment">
            ...
            <div class="d-flex justify-content-around">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioRaid" id="radio21" data-price="0.00" value="Hardware RAID (FREE)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getRaid())) eq 'hardware raid (free)'}">
                               checked
                           </c:if>
                           />
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="radioRaid" id="radio22" data-price="5.00" value="Software RAID (€5.00)"
                           <c:if test="${fn:toLowerCase(fn:trim(server.getRaid())) eq 'software raid (€5.00)'}">
                               checked
                           </c:if>
                           />
    ...
    <script src="../public/script/editServer.js"></script>
</body>
</html>
